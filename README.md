...
<img align="left" alt="GIF" src="https://github.com/adi-code22/Voting-App-IEDC/blob/main/assets/git_img/home.PNG?raw=true"  width="200"/>  
<img align="left" alt="GIF" src="https://github.com/adi-code22/Voting-App-IEDC/blob/main/assets/git_img/registerd.PNG?raw=true"  width="200"/>
...
The app gives you options to select according to preset values

- After you select any entry, there will be a 5 sec gap. This is to avoid multiple votes done by a single user.
- Votes are then moved to shared preferences
...
<p>&nbsp;</p>
<img align="left" alt="GIF" src="https://github.com/adi-code22/Voting-App-IEDC/blob/main/assets/git_img/results.PNG?raw=true"  width="200"/>
...
## Results
Results are kept in a seperate screen



- Passcode is asked for results to be shown.
...
1. Clone the repo
   ```sh
   git clone https://github.com/adi-code22/Voting-App-IEDC.git
   ```
...
Project Link: [https://github.com/adi-code22/Voting-App-IEDC](https://github.com/adi-code22/Voting-App-IEDC)
